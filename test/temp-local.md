...
<py>pure PY tab name</py>

<py-java-cs>PY JAVA CS tab name</py-java-cs>

<python>pure PYTHON tab name</python>

<python-java-cs>PYTHON JAVA CS tab name</python-java-cs>
