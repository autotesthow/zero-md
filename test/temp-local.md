...
## <ru>Что и где? - в караганде</ru><uk>Що і де? - в караганде</uk><en>What and where? - in Karagandere</en>
...
### <ru>Структура проекта - проекта</ru><uk>Структура проекту - проекта</uk><en>Project structure</en>
